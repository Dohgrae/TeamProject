...
// 직장 경험을 추가할 때 순서대로 묻는 8가지 질문 (Dohgrae 버전)
...
// 인터뷰 답변 사이사이에 랜덤으로 보여주는 대화체 반응 (서버 호출 없이 미리 준비된 문구)
const WORK_INTERVIEW_ACKS = ["그렇군요!", "네, 잘 알겠습니다.", "좋은 경험이네요.", "아, 그러셨군요.", "말씀 감사해요.", "흥미로운 이야기네요."];
